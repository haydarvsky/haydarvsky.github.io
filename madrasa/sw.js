...
var V = 'madrasa-v20';
var SHELL = ['/madrasa/', '/madrasa/index.html', '/madrasa/css/madrasa.css?v=20', '/madrasa/js/fb.js?v=20', '/madrasa/js/charts.js?v=20', '/madrasa/js/app.js?v=20', '/madrasa/js/deck-export.js?v=20', '/madrasa/manifest.webmanifest',
...
self.addEventListener('fetch', function (e) {
  ...
  if (u.pathname.indexOf('/madrasa/books/') === 0 && /\.pdf$/i.test(u.pathname)) return; /* الكتبُ كبيرة: من الشبكةِ مباشرةً بلا تخزين */
